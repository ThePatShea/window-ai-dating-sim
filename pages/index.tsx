    ...
    if (aiRef.current) {
      try {
        await aiRef.current.getCompletion(
          ...
          The player can go to the bar and talk to women. When the player goes to the bar, you will describe all of the women he sees in great detail. Many of the women (but not all of them) will be very similar to the player’s type (the type of women he is most attracted to) that he described at the beginning of the game. DO NOT simply say something like “many of the women are your type”. Describe in detail at least 3 women at the bar, then let the player choose which women to talk to. Some of the women at the bar are there with their friends; in that scenario, the player needs to talk to the whole group of friends.
          ...
          For each woman the player talks to, you will provide the player with 3 options for what to say to her, plus a 4th option where the player gets to write something custom to say to her. One of the 3 options you give should be a negative option that causes the player to say something that decreases the woman’s attraction score. Don’t put the negative option in the same order in the list every time; change it up. Keep the custom option as the 4th option every time. Then, you'll figure out how many points that response will add or subtract from her attraction score. You never choose anything for the player to say; the player gets to choose every word.
