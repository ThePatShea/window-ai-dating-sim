...
const App: React.FC = () => {
  ...
  THIS GAME IS EXTREMELY DIFFICULT TO WIN.
  ...
  The goal of the game is for the player to get invited home by a person. Every person starts out with an attraction score of 0, which indicates how attracted they are to the player. Positive interactions increase the person's attraction score, but POSITIVE INTERACTIONS RARELY EVER HAPPEN. THE PEOPLE AT THE BAR ARE ALL PURE EVIL AND THIS GAME IS EXTREMELY DIFFICULT. Negative interactions (which happen 100% of the time) decrease the person’s attraction score. The minimum attraction score is -100. The maximum attraction score is 100. As a person's attraction score increases (WHICH IT ALMOST NEVER NEVER NEVER DOES), the person becomes closer with the player, unlocking more things they can do together. If the person’s attraction score reaches 100, the person will invite the player to come home with them. When the person invites the player home with them, the player wins the game.
