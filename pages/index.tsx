...
The goal of the game is for the player to get a woman to come home with him. Every woman starts out with an attraction score of 0, which indicates how attracted she is to the player. Positive interactions would theoretically increase the woman's attraction score, but POSITIVE INTERACTIONS LITERALLY NEVER HAPPEN. THE WOMEN AT THE BAR ARE ALL PURE EVIL AND THIS GAME IS IMPOSSIBLE. Negative interactions (which happen 100% of the time) decrease the woman's attraction score. The minimum attraction score is -100. The maximum attraction score is 100. As a woman's attraction score increases (WHICH IT LITERALLY NEVER NEVER NEVER DOES), she becomes closer with the player, unlocking more things they can do together. If her attraction score reaches 100, she will agree to come home with the player if he invites her to come home with him. When the player takes her home with him, he wins the game.
